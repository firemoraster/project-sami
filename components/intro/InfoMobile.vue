<template>
  <section class="info-mob">
    ...
    <div class="vision">
      <div class="title-2 h3">{{ infoData.description2 }}</div>
      ...
      <div class="description-2">
        <p class="p3">{{ infoData.description3 }}</p>
      </div>
...
.info-mob {
  padding: var(--256) var(--16) var(--152);
  overflow: hidden;
  display: none;
