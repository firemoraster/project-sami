...
.gradient-1 {
  top: 0;
  height: 35%;
  background: linear-gradient(180deg, #A0C9E9 0%, rgba(160, 201, 233, 0.35) 49.9%, rgba(160, 201, 233, 0.14) 71.4%, rgba(160, 201, 233, 0.04) 84.9%, rgba(160, 201, 233, 0.00) 100%);
